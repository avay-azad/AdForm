namespace AdFormAssignment.Shared
{
    public static  class ErrorMessage
    {
        ...
        public static readonly string List_Exist = "This item is allready exists";
        public static readonly string List_Not_Exist = "This item is not exists";
        public static readonly string List_Name_Empty = "Please provied item name";
