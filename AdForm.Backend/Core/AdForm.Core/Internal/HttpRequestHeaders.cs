namespace AdForm.Core
{
    public static class HttpRequestHeaders
    {
        ...
        /// <summary> Reuest header for multipart form data </summary>
        public const string MultipartFormData = "multipart/form-data";

        /// <summary>The internal API token header </summary>
        public const string InternalApiTokenHeader = "Internal-Api";
        /// <summary>The internal API token </summary>
        public const string InternalApiToken = "Internal-Api-Token";
